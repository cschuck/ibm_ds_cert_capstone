...
def get_scatter_chart(entered_site, payload_mass):
    # print(type(payload_mass))
    # print(payload_mass[0])
    # print(payload_mass[1])
    if entered_site == 'ALL':
        filtered_df = spacex_df[spacex_df['Payload Mass (kg)'] >= payload_mass[0]]# and spacex_df['Payload Mass (kg)'] <= payload_mass[1]]
